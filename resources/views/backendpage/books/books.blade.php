    ...
    <section class="content">
        ...
        <div class="card card-info">
          <div class="card-header">
            <h3 class="card-title">Books Add</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form class="form-horizontal"method="post" action="{{ route('store.books') }}"enctype="multipart/form-data">
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <textarea type="text" class="form-control"name="description" id="inputPassword3" placeholder="Description"></textarea>
                </div>
              </div>
